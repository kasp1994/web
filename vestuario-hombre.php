	...
	<div class="content">	 	 
		       <div class="top-grids">
					...
					<ul><br>
						...
						$sql = $db->query("select * from productoshombre;");
						...
						if ($nfilas > 0){
							for ($i=0; $i<$nfilas; $i++) {
								...
								echo '<li><a href="compra.html"><img src="images/'.$dato['imagen'].'" alt="" /><span>'.$dato['nombre'].'   -   $'.$dato['precio'].'</span></a><div class="button"><span><a href="compra.html">Ver en Detalle</a></span><br><br></div></li>';
